 ...
 * a codec header byte, and sends via PacketRouter.
 *
 * **Wire Format:**
 ...
 * - PacketRouter.sendPacket uses Dispatchers.IO (non-blocking)
 *
 * **CRITICAL:** No Log.d() in handleFrame - this is the audio hot path.
 *
 * @param bridge PacketRouter for sending packets to Python
...
class Packetizer(
     ...
     * header byte, and sends via PacketRouter.
     *
