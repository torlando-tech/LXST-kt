 ...
 *
 * Wraps AudioDevice to provide LXST-compatible source interface.
 ...
 *
 * IMPORTANT: AudioDevice.readAudio() returns FILTERED audio.
 * Bridge applies BPF/LPF internally (<1ms overhead). LineSource only adds gain.
 *
 * @param bridge AudioDevice instance for audio capture
