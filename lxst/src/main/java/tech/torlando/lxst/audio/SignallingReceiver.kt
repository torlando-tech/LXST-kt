 ...
 *
 * @param bridge PacketRouter for sending signals to Python
...
class SignallingReceiver(
     ...
     *
     * Non-blocking: delegates to PacketRouter which dispatches on IO thread.
     ...
     * Called from PacketRouter when Python delivers a signal.
     *
